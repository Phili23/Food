...

            {
               detailsstate.length > 0 ?
                    <div  >
                        ...
                        <> <img className='imga' src={detailsstate[0].image ? detailsstate[0].image : 'https://st.depositphotos.com/1036708/2191/i/600/depositphotos_21918797-stock-photo-knife-and-fork-with-plate.jpg' } alt="Img of Foods" /></>
                        <div className=''>
