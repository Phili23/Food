  ...
  function handleDeleteRecipe(e) {
    ...
    return (
        <div className="card-containers">
          ...
          <span className="">{image ? <img className="imga" src={image} alt="not found" /> : <img className="imga1"  src='https://i0.wp.com/revistadiners.com.co/wp-content/uploads/2020/07/portada_rutaazteca_1200x800.jpg?fit=1024%2C683&ssl=1'  alt="img not found" width='200px' height='125px'   />}<br/></span> 
